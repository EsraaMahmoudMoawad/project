...
?>			  	
			    <tr>
			      ...
			      <td>
				  <a  href="details.php?id=<?php echo $key_products['id']; ?>" class="btn btn-info">View Details</a>
			      	<a  href="edit_product.php?id=<?php echo $key_products['id']; ?>" class="btn btn-warning">Edit</a>
